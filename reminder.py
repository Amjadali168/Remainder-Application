...
def ReminderWindow(title, message):
    ...
    # Set the size of the window (adjust these values as needed)
    win.geometry("400x200")  # Width x Height
...
print('-------------------------------------------------')
print('Once started, the app runs indefinitely until you ask it to stop.')
